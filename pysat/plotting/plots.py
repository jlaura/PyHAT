...
def scatterplot(x,y,xrange=None,yrange=None,xtitle=None,ytitle=None,title=None,lbls=None,one_to_one=False,figpath=None,figname=None,dpi=1000,colors=None):
    if colors==None:
    ...
    for i in np.arange(len(x)):
        plot.scatter(x[i],y[i],c=next(colors),label=lbls[i],edgecolors='black',linewidth=0.1)
