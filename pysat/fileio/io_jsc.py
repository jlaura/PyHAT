...
def JSC(input_files,refdata):
    try:
        ...
        compcols=['SiO2','TiO2','Al2O3','Cr2O3','Fe2O3T','MnO','MgO','CaO','Na2O','K2O','P2O5','SO3 LOI Residue','Total','Total Includes','%LOI','FeO',
                 'Fe2O3','SO3 Actual','Fe(3+)/Fe(Total)','Rb (ug/g)','Sr (ug/g)','Y (ug/g)','Zr (ug/g)','V (ug/g)','Ni (ug/g)','Cr (ug/g)',
                'Nb (ug/g)','Ga (ug/g)','Cu (ug/g)','Zn (ug/g)','Co (ug/g)','Ba (ug/g)','La (ug/g)','Ce (ug/g)','U (ug/g)','Th (ug/g)','Sc (ug/g)',
        ...
        os.rename(input_file,r"C:\\Users\\rbanderson\\Documents\\Projects\\LIBS PDART\\Database\\LIBS USGS\\Problem_Files\\"+os.path.basename(input_file))
        return None
