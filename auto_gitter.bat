...
%USERPROFILE%\AppData\Local\GitHub\PortableGit_d76a6a98c9315931ec4927243517bc09e9b731a0\cmd\git.exe config --global url."https://tisaconundrum2:MVLwlDMi1106-2@github.com"
