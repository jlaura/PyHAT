"""
The bulk of the code for the different methods here was adapted from code provided by Tommy Boucher (boucher@cs.umass.edu).
All errors in adapting the code for PyHAT are the fault of Ryan Anderson (rbanderson@usgs.gov)
"""
