...
def test_bd620(three_dim, wv_array, expected):
    data = Spectra(three_dim, wv_array, waxis = 0, tolerance = 2)
...
def test_iralbedo(one_dim, wv_array, expected):
    data = Spectra(one_dim, wv_array, waxis = 0, tolerance = 2)
...
def test_mafic_abs(two_dim, wv_array, expected):
    data = Spectra(two_dim, wv_array, waxis = 0, tolerance = 2)
...
def test_olindex(five_dim, wv_array, expected):
    data = Spectra(five_dim, wv_array, waxis = 0, tolerance = 2)
...
def test_bdi1000(thirty_dim, wv_array, expected):
    print(wv_array)
    data = Spectra(thirty_dim, wv_array, waxis = 0, tolerance = 2)
...
def test_bdi2000(twenty_five_dim, wv_array, expected):
    print(wv_array)
    data = Spectra(twenty_five_dim, wv_array, waxis = 0, tolerance = 2)
