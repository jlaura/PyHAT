...
def test_bd1umratio(four_dim, wv_array, expected):
    res = dev.bd1umratio(Spectra(four_dim, wv_array, waxis = 0), wv_array)
...
def test_h2o2(five_dim, wv_array, expected):
    res = dev.h2o2(Spectra(five_dim, wv_array, waxis = 0), wv_array)
    assert res.all() == expected
...
def test_h2o3(five_dim, wv_array, expected):
    res = dev.h2o3(Spectra(five_dim, wv_array, waxis = 0), wv_array)
    assert res.all() == expected
...
def test_h2o4(six_dim, wv_array, expected):
    res = dev.h2o4(Spectra(six_dim, wv_array, waxis = 0), wv_array)
    assert res.all() == expected
...
def test_h2o5(five_dim, wv_array, expected):
    res = dev.h2o5(Spectra(five_dim, wv_array, waxis = 0), wv_array)
    assert res.all() == expected
...
def test_ice(six_dim, wv_array, expected):
    res = dev.ice(Spectra(six_dim, wv_array, waxis = 0), wv_array)
    assert res.all() == expected
...
def test_bd2umratio(four_dim, wv_array, expected):
    res = dev.bd2umratio(Spectra(four_dim, wv_array, waxis = 0), wv_array)
    assert res.all() == expected
