...
def r770(data, **kwargs):
    ...
    wv = [770]
    kernels = {770:5}
    res = utils.generic_func(data, wv, kernels=kernels, func = cf.rockdust1_func, **kwargs)
    return res
...
def rbr(data, **kwargs):
    ...
    kernels = {440:5,
               770:5}
    return(utils.generic_func(data, wv, kernels=kernels, func=cf.rockdust2_func, **kwargs))
...
'''def bd530(data, **kwargs):
    ...
    """
    wv = [440,530,709]
    return(utils.generic_func(data, wv, func = cf.bd530_func, **kwargs))
...
def sh600(data, **kwargs):
    ...
    """
    wv = [533,600,710]
    return(utils.generic_func(data, wv, func=cf.sh600_func, **kwargs))
...
def bd640(data, **kwargs):
    ...
    """
    wv = [600,648,709]
    return(utils.generic_func(data, wv, func = cf.bd640_func, **kwargs))
...
def bd860(data, **kwargs):
    ...
    """
    wv = [800,860,984]
    return(utils.generic_func(data, wv, func = cf.bd860_func, **kwargs))
...
def bd920(data, **kwargs):
    ...
    """
    wv = [800,920,984]
    return(utils.generic_func(data, wv, func = cf.bd920_func, **kwargs))
...
def ira(data, **kwargs):
    ...
    """
    wv = [1330]
    return(utils.generic_func(data, wv, func = cf.ira_func, **kwargs))
...
def olivine_index(data, **kwargs):
    ...
    return(utils.generic_func(data, wv, func = cf.olivine_index_func, **kwargs))
...
def hcp_index(data, **kwargs):
    ...
    """
    wv = [1080,1470,2067]
    return(utils.generic_func(data, wv, func = cf.hcp_index_func, **kwargs))
...
def lcp_index(data, **kwargs):
    ...
    """
    wv = [1080,1330,1815]
    return(utils.generic_func(data, wv, func = cf.lcp_index_func, **kwargs))
...
def islope1(data, **kwargs):
    ...
    """
    wv = [1815,2530]
    return(utils.generic_func(data, wv, func = cf.islope1_func, **kwargs))
...
def bd1435(data, **kwargs):
    ...
    """
    wv = [1370,1430,1470]
    return(utils.generic_func(data, wv, func = cf.bd1435_func, **kwargs))
...
def bd1500(data, **kwargs):
    ...
    return(utils.generic_func(data, wv, func = cf.bd1500_func, **kwargs))
...
def icer1(data, **kwargs):
    ...
    """
    wv = [1430,1510]
    return(utils.generic_func(data, wv, func = cf.icer1_func, **kwargs))
...
def bd1750(data, **kwargs):
    ...
    """
    wv = [1557,1750,1815]
    return(utils.generic_func(data, wv, func = cf.bd1750_func, **kwargs))
...
def bd1900(data, **kwargs):
    ...
    return(utils.generic_func(data, wv, func = cf.bd1900_func, **kwargs))
...
def bd2100(data, **kwargs):
    ...
    return(utils.generic_func(data, wv, func = cf.bd2100_func, **kwargs))
...
def bd2210(data, **kwargs):
    ...
    """
    wv = [2140,2210,2250]
    return(utils.generic_func(data, wv, func = cf.bd2210_func, **kwargs))
...
def bd2290(data, **kwargs):
    ...
    """
    wv = [2250,2290,2350]
    return(utils.generic_func(data, wv, func = cf.bd2290_func, **kwargs))
...
def d2300(data, **kwargs):
    ...
    return(utils.generic_func(data, wv, func = cf.d2300_func, **kwargs))
...
def sindex(data, **kwargs):
    ...
    """
    wv = [2100,2400,2290]
    return(utils.generic_func(data, wv, func = cf.sindex_func, **kwargs))
...
def icer2(data, **kwargs):
    ...
    """
    wv = [2530,2600]
    return(utils.generic_func(data, wv, func = cf.icer2_func, **kwargs))
...
def bdcarb(data, **kwargs):
    ...
    return(utils.generic_func(data, wv, func = cf.bdcarb_func, **kwargs))
...
def bd3000(data, **kwargs):
    ...
    """
    wv = [2210,2530,3000]
    return(utils.generic_func(data, wv, func = cf.bd3000_func, **kwargs))
...
def bd3100(data, **kwargs):
    ...
    """
    wv = [3000,3120,3250]
    return(utils.generic_func(data, wv, func = cf.bd3100_func, **kwargs))
...
def bd3200(data, **kwargs):
    ...
    """
    wv = [3250,3320,3390]
    return(utils.generic_func(data, wv, func = cf.bd3200_func, **kwargs))
...
def bd3400(data, **kwargs):
    ...
    return(utils.generic_func(data, wv, func = cf.bd3400_func, **kwargs))
...
def cindex(data, **kwargs):
    ...
    """
    wv = [3630,3750,3950]
    return(utils.generic_func(data, wv, func = cf.cindex_func, **kwargs))'''
